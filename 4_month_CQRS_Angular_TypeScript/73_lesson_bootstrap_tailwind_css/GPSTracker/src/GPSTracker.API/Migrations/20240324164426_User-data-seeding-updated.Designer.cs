...
namespace GPSTracker.API.Migrations
{
    ...
    [Migration("20240324164426_User-data-seeding-updated")]
    partial class Userdataseedingupdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GPSTracker.API.Domain.Entities.Auth.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ExpireDate = new DateTime(2024, 3, 25, 21, 44, 25, 845, DateTimeKind.Local).AddTicks(7879),
